      ...
      <div className="container">
        <div className="bg-[#FFFFFF] border-[1px] border-solid border-[#D8D8D880] max-w-[1088px] rounded-[10px] pt-[35px] pb-[77px] sm:px-[42px] px-5 mb-32">
          <form onSubmit={handleSubmit}>
            ...
            <label
              htmlFor="file-upload"
              className="bg-[#F8F8F8]  py-[18px] px-5  w-[130px]  flex items-center justify-center border-[1px] border-dashed rounded-[10px] border-[#00000033]  cursor-pointer "
            >
              <Uploadimg />
            </label>
            ...
            <div className="flex gap-3 items-center pb-10">
              <label
                htmlFor="publishNow"
                className="font-outfit font-normal text-[18px] leading-[100%] text-[#252525B2]  pt-[22px] inline-block pb-[13px]"
              >
                Publish Now
              </label>
              <input
            ...
            <input
              type="submit"
              value="Add blog"
              className="text-white cursor-pointer border-[1px]  hover:bg-white duration-300 hover:border-[#5044E5]  hover:text-[#5044E5] font-outfit text-[16px] leading-[100%] bg-[#5044E5] rounded-[4px] py-3 px-[46px]"
            />
          </form>
        </div>
      </div>
